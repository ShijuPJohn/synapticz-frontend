...
export default function SavedExplanationsPage() {
    ...
    if (loading) {
        return (
            <div
                className="w-[100%] mx-auto p-2 md:p-4 lg:p-8 flex flex-col items-center justify-center bg-white min-h-[100vh]">
        ...
        <div className="p-4  mx-auto space-y-4 bg-white min-h-[90vh]">
            ...
            {explanations.length === 0 ? (
                ...
                explanations.map(exp => (
                    <div key={exp.id}
                         className="rounded-2xl shadow-md border border-gray-200 bg-white p-4 space-y-3">
                        ...
                        <p className="text-sm text-yellow-800"><MarkdownWithMath content={exp.explanation}/></p>
