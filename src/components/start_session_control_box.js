...
function StartSessionControlBox({qid}) {
    ...
    return (<>
        ...
        <div className={"w-full flex items-center justify-center mb-16"}>
            <button
                disabled={loading}
                className="bg-blue-600 hover:bg-blue-700 disabled:bg-blue-300 disabled:shadow-none hover:shadow-lg transform hover:-translate-y-0.5 w-full max-w-md uppercase text-white px-8 py-3 rounded-lg font-semibold shadow-lg transition-all duration-300"
                onClick={() => {
